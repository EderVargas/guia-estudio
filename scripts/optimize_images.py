...
CONFIG = {
    ...
    # Materias a procesar
    'subjects': ['matematicas', 'lenguajes', 'conocimientoMedio', 'formacionCivicaEtica', 'inglesExamen', 'inglesExamen2doTrimestre', 'matematicas2doTrimestre', 'conocimientoMedio2doTrimestre'],
